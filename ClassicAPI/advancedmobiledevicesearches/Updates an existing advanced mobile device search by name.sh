...
# Classic API > advancedcomputersearches > Updates an existing advanced mobile device search by ID
#
...
# Update existing advanced mobile device search with request body
curl --request PUT \
--url ${jamfProURL}/JSSResource/advancedmobiledevicesearches/name/${name} \
