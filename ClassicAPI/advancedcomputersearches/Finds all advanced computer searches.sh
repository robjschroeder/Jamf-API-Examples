...
# Classic API > advancedcomputersearches > Finds all advanced computer searches
#
# Created 10.04.2022 @robjschroeder
...
curl --request GET \
--url ${jamfProURL}/JSSResource/advancedcomputersearches \
