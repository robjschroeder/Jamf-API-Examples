...
# Classic API > advancedcomputersearches > Deletes a computer search by name
#
...
# Deletes a computer searches by name
curl --request DELETE \
--url ${jamfProURL}/JSSResource/advancedcomputersearches/name/${name} \
