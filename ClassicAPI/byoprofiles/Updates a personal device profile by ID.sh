...
# Classic API > byoprofiles > Updates a personal device profile by ID
#
...
# Update personal device profile with request body
curl --request PUT \
--url ${jamfProURL}/JSSResource/byoprofiles/id/${id} \
