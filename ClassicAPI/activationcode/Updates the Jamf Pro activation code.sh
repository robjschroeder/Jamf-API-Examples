...
# Classic API > activationcode > Updates the Jamf Pro activation code
#
# Created 09.24.2022 @robjschroeder
...
requestBody="<activation_code>
    <organization_name>Organization Name</organization_name>
    <code>ABCD-1234-A1B2-AAAA-BBBB-CCCC-DDDD-EEEE</code>
</activation_code>"
...
# Update activation code with request body
curl --request PUT \
--url ${jamfProURL}/JSSResource/JSSResource/activationcode \
