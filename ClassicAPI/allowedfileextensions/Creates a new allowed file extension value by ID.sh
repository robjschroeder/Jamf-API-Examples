...
# Classic API > allowedfileextensions > Creates a new allowed file extension value by ID
#
...
requestBody="<allowed_file_extension>
...
curl --request POST \
--url ${jamfProURL}/JSSResource/allowedfileextensions/id/0 \
